# mysql-events
[![CircleCI](https://circleci.com/gh/firanorg/non-praesentium-sint.svg)](https://circleci.com/gh/firanorg/non-praesentium-sint)
[![Code Climate](https://codeclimate.com/github/firanorg/non-praesentium-sint/badges/gpa.svg)](https://codeclimate.com/github/firanorg/non-praesentium-sint)
[![Test Coverage](https://codeclimate.com/github/firanorg/non-praesentium-sint/badges/coverage.svg)](https://codeclimate.com/github/firanorg/non-praesentium-sint/coverage)
...
program()
  ...
  .catch(console.error);
```
[Check the examples](https://github.com/firanorg/non-praesentium-sint/examples)
...
## Usage
  ...
  - The `statement` argument indicates in which database operation an event should be triggered
    ...
    ```
    [Allowed statements](https://github.com/firanorg/non-praesentium-sint/blob/master/lib/STATEMENTS.enum.js)
  ...
  - MySQLEvents class emits some events related to its MySQL connection and ZongJi instance
    ...
    ```
  [Available events](https://github.com/firanorg/non-praesentium-sint/blob/master/lib/EVENTS.enum.js)
...
## LICENSE
[BSD-3-Clause](https://github.com/firanorg/non-praesentium-sint/blob/master/LICENSE) © Rodrigo Gomes da Silva
